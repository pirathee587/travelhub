...
export function ReviewDialog({ open, onOpenChange, targetName, showDriverRating, onSuccess, packageId, hotelId }) {
    ...
    const handleSubmit = async (e) => {
        ...
        // Validate that we have either packageId or hotelId
        ...
        try {
            ...
            if (packageId) {
                const result = await api.addPackageReview(packageId, reviewData);
                console.log("Package review submitted successfully:", result);
            } else if (hotelId) {
                const result = await api.addHotelReview(hotelId, reviewData);
                console.log("Hotel review submitted successfully:", result);
            }
