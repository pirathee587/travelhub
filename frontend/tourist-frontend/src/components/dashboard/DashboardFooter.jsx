                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li>
                                <Link to="/overview" className="text-muted-foreground hover:text-primary transition-colors text-sm flex items-center gap-2">
                                    <div className="h-1 w-1 rounded-full bg-primary" />
                                    Travel Dashboard
                                </Link>
                            </li>
                            <li>
                                <Link to="/trips" className="text-muted-foreground hover:text-primary transition-colors text-sm flex items-center gap-2">
                                    <div className="h-1 w-1 rounded-full bg-primary" />
                                    My Bookings
                                </Link>
                            </li>
