...
import { Textarea } from "@tourist/components/ui/textarea";
...
import {
    ...
    CardHeader,
    CardTitle,
} from "@tourist/components/ui/card";
import {
    ArrowLeft,
    Calendar,
    Users,
...
const PackageReservation = () => {
        ...
        if (selectedHotelId && preferenceNumber) {
            api.getHotelById(selectedHotelId).then(hotel => {
                if (hotel) {
                    ...
                    navigate(`/tourist/explore/package/${id}/reserve`, { replace: true });
                }
            });
        }
    ...
    navigate(
        `/tourist/hotels?mode=select&preference=${preferenceNumber}&returnTo=/tourist/explore/package/${id}/reserve&district=${pkg.district}`
    );
};
