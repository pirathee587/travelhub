...
import { Avatar, AvatarFallback } from "@tourist/components/ui/avatar";
import { useState, useMemo, useCallback } from "react";
import { cn } from "@tourist/lib/utils";
import { usePackageById, usePackageReviews, usePackageRating } from "@tourist/hooks/useApi";
import { DetailSkeleton } from "@tourist/components/ui/skeletons";
import { EditReviewDialog } from "@tourist/components/dashboard/EditReviewDialog";
import { DeleteConfirmDialog } from "@tourist/components/dashboard/DeleteConfirmDialog";
                ...
                <div className="flex flex-col md:flex-row justify-between items-start gap-4">
                    ...
                    <div className="text-right">
                        ...
                        <Button
                            ...
                            onClick={() => navigate(`/tourist/explore/package/${pkg.id}/reserve`)}
                        >
                            Reserve Now
                        </Button>
                    </div>
