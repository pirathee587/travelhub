...
import { packages } from '@agent/data/packages';
...
import { Badge } from '@agent/components/ui/badge';
                      ...
                      <div className="space-y-3 p-4 border rounded-lg bg-muted/20 relative">
                        ...
                        <div>
                          ...
                          <Textarea
                            ...
                            onChange={(e) =>
                              updateActivity(idx, 'description', e.target.value)
                            }
                          />
                        </div>
                        <div>
                          ...
                          {activity.image ? (
                            ...
                            <div className="relative border border-dashed border-input rounded-md p-2 hover:bg-muted/50 cursor-pointer w-full text-center">
                              <input
                                ...
                                accept="image/*"
                                onChange={(e) =>
                                  handleActivityImageUpload(idx, e)
                                }
                              />
