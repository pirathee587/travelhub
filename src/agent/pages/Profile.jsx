...
import { Textarea } from '@agent/components/ui/textarea';
import {
  Dialog, DialogContent, DialogHeader, DialogTitle, DialogTrigger,
} from '@agent/components/ui/dialog';
import {
  Select, SelectContent, SelectItem, SelectTrigger, SelectValue,
} from '@agent/components/ui/select';
...
const Profile = () => {
  ...
  const displayName = profile?.agentName || 'Agent';
          ...
          <div className="rounded-xl border border-border bg-card p-6">
            ...
            <div className="mt-6 pt-6 border-t border-border grid grid-cols-2 gap-4">
              <div className="text-center">
                <p className="text-2xl font-bold text-foreground">{profile?.totalTrips ?? 0}</p>
                <p className="text-xs text-muted-foreground">Total Trips</p>
              </div>
              <div className="text-center">
                <p className="text-2xl font-bold text-foreground">{profile?.completionRate ?? 0}%</p>
                ...
                <div className="space-y-4 py-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input value={editForm.agentName || ''} onChange={e => setEditForm({ ...editForm, agentName: e.target.value })} placeholder="Your full name" />
                    </div>
                    <div className="space-y-2">
                      <Label>Company Name</Label>
                      <Input value={editForm.companyName || ''} onChange={e => setEditForm({ ...editForm, companyName: e.target.value })} placeholder="Your agency name" />
                    </div>
                    <div className="space-y-2">
                      <Label>Email</Label>
                      <Input value={editForm.email || ''} disabled className="bg-muted text-muted-foreground" title="Email cannot be edited" />
                    </div>
                    <div className="space-y-2">
