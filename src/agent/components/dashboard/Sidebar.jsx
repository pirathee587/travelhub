...
const navItems = [
  ...
  { icon: Car, label: 'Vehicles & Drivers', path: '/agent/vehicles' },
  { icon: CalendarCheck, label: 'Bookings', path: '/agent/bookings' },
  { icon: Package, label: 'Packages', path: '/agent/packages' },
