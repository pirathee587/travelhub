...
const initialReviews = [
  ...
  },
  {
    ...
    rating: 5,
    comment:
      'The train ride to Ella was magical. Great hotel recommendations in Nuwara Eliya.',
    date: '2024-05-10',
    trip: 'Ella, Badulla',
  ...
  },
  {
    ...
    rating: 4,
    comment:
      'Wonderful beach vacation in Mirissa. Whale watching was a highlight.',
    date: '2024-05-02',
    trip: 'Mirissa, Matara',
  ...
  },
  {
    ...
    rating: 5,
    comment:
      'Best travel agent for a Yala safari! We saw three leopards. Unforgettable.',
    date: '2024-04-28',
  ...
  },
  {
    ...
    rating: 5,
    comment:
      'Our honeymoon in Galle was a dream come true. The Fort is beautiful.',
    date: '2024-04-15',
  ...
  },
  {
    ...
    rating: 4,
    comment:
      'Loved the food in Jaffna. The guide was very knowledgeable about Tamil culture.',
    date: '2024-04-05',
    trip: 'Jaffna',
  ...
  },
  {
    ...
    rating: 2,
    comment:
      'Had some issues with hotel check-in at Kandy. Could have been better coordinated.',
    date: '2024-03-15',
    trip: 'Kandy',
    package: 'Cultural Triangle Heritage',
  },
  {
    ...
    rating: 5,
    comment:
      'Polonnaruwa ruins were stunning. Historical richness is incredible.',
    date: '2024-03-10',
    trip: 'Polonnaruwa',
    package: 'Cultural Triangle Heritage',
  },
  ...
  const filteredReviews = reviewsState
    .filter((review) => {
      if (ratingFilter !== 'all' && review.rating !== parseInt(ratingFilter))
        return false;
      if (destinationFilter !== 'all' && review.trip !== destinationFilter)
        return false;
      if (packageFilter !== 'all' && review.package !== packageFilter)
        return false;
      return true;
    })
    .sort((a, b) => {
