...
export function TravelCard({ recommendation, className, onClick, children, showHotelHeader }) {
    ...
    return (
        <div
            className={cn(
                "group relative flex flex-col flex-shrink-0 w-72 h-[330px] overflow-hidden rounded-xl bg-card border border-border",
        ...
        >
            ...
            <div className="p-4 flex flex-col flex-1 min-h-0">
                ...
                {showHotelHeader ? (
                    <>
                        {/* Hotel Name */}
                        <h3 className="font-semibold text-foreground group-hover:text-primary transition-colors mb-1 min-h-[2.75rem] leading-snug whitespace-normal break-words">
