...
const reviews: Review[] = [
  {
    ...
    rating: 5,
    comment: "Amazing experience! The driver was professional and the vehicle was spotless. Highly recommend!",
    date: "2 days ago",
    trip: "Bali, Indonesia",
  },
  {
    ...
    rating: 5,
    comment: "Perfect holiday. Everything was arranged seamlessly. Will definitely book again!",
    date: "1 week ago",
    trip: "Maldives",
  },
  {
    ...
    rating: 4,
    comment: "Great service overall. Minor delay on pickup but the trip was wonderful.",
    date: "2 weeks ago",
    trip: "Swiss Alps",
  },
];
